<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="readmysqldatabase.aspx.cs" Inherits="mysite.readmysqldatabase" %>
        ...
        <div> <asp:Literal ID="Literal1" runat="server"></asp:Literal>
           ...
           <ItemTemplate>  
               <%#Eval("Utility")%>  
                   	...
                   	<asp:TemplateField HeaderText="Allocation-MW" HeaderStyle-HorizontalAlign="Center">  
           <ItemTemplate>  
               <%#Eval("MW")%>  
           </ItemTemplate>  
                        <HeaderStyle HorizontalAlign="Center" />
