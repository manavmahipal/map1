<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="readmysqldatabase_station.aspx.cs" Inherits="mysite.readmysqldatabase_station" %>
...
<body>
    ...
    <!-- <div style="width:100%;height: 50px; background-color: deepskyblue; background-image: radial-gradient( #c6e9f7,#05adf0 );font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size:30px;text-align:center;vertical-align:middle;"><b>Merit Order Dashboard</b></div>
       <br/><br/> --><div style="font-size:larger;">
            Select Station : &nbsp;&nbsp; <asp:DropDownList ID="DDL_for_station" runat="server" AutoPostBack="true" OnSelectedIndexChanged="station_DDL_change" DataTextField="Station" DataValueField="Station" EnableIncrementalSearch="true" ></asp:DropDownList>  
        ...
        <div> <asp:Literal ID="Literal1" runat="server"></asp:Literal>
           ...
           <ItemTemplate>  
               <%#Eval("Station")%>  
                   ...
                   <asp:TemplateField HeaderText="Utility" HeaderStyle-HorizontalAlign="Center">  
           <ItemTemplate>  
               <%#Eval("Utility")%>  
           </ItemTemplate>  
                       <HeaderStyle HorizontalAlign="Center" />
