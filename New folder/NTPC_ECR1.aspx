<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NTPC_ECR1.aspx.cs" Inherits="merit.NTPC_ECR1" %>
...
<body>
    <script>
        $(function () {
            ...
            $("#<%=DDL_for_month.ClientID%>").select2();
    })
    </script>
    ...
    <!-- <div style="width:100%;height: 50px; background-color: deepskyblue; background-image: radial-gradient( #c6e9f7,#05adf0 );font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size:30px;text-align:center;vertical-align:middle;"><b>Merit Order Dashboard</b></div>
       <br/><br/> --><div style="font-size:larger;">
        ...
        <div style="font-size:larger;">
            Select Month : &nbsp;&nbsp; <asp:DropDownList ID="DDL_for_month" runat="server" Width="300px" AutoPostBack="true" OnSelectedIndexChanged="month_DDL_change" ></asp:DropDownList>  
        </div><br/>
    ...
    <div id="container" style="margin-left: 0px;"></div>
        ...
        <div> <asp:Literal ID="Literal1" runat="server"></asp:Literal> <asp:Literal ID="Literal2" runat="server"></asp:Literal>
            <asp:GridView ID="testgrid" runat="server" CssClass="hover" OnRowDataBound="grd_RowDataBound" AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical"> 
               ...
               <Columns>
							<asp:TemplateField HeaderText="station_name" HeaderStyle-HorizontalAlign="Center">  
           <ItemTemplate>  
               <%#Eval("station_name")%>  
           </ItemTemplate>  
           ...
           <ItemTemplate>  
               <%#Eval("month")%>  
                   ...
                   <asp:TemplateField HeaderText="ECR" HeaderStyle-HorizontalAlign="Center">  
           <ItemTemplate>  
               <%#Eval("ECR")%>  
           </ItemTemplate>  
                                <HeaderStyle HorizontalAlign="Center" />
             ...
             <asp:GridView ID="testgrid1" runat="server" CssClass="hover" OnRowDataBound="grd_RowDataBound" AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical"> 
                <AlternatingRowStyle BackColor="White" />
               <Columns>
							<asp:TemplateField HeaderText="state_name" HeaderStyle-HorizontalAlign="Center">  
           <ItemTemplate>  
               <%#Eval("state")%>  
           </ItemTemplate>  
                                <HeaderStyle HorizontalAlign="Center" />
