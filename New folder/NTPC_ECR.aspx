<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NTPC_ECR.aspx.cs" Inherits="merit.NTPC_ECR" %>
...
<body>
    <script>
        $(function () {
            ...
            $("#<%=DDL_for_state_filter.ClientID%>").select2();
    })
    </script>
    ...
    <!-- <div style="width:100%;height: 50px; background-color: deepskyblue; background-image: radial-gradient( #c6e9f7,#05adf0 );font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size:30px;text-align:center;vertical-align:middle;"><b>Merit Order Dashboard</b></div>
       <br/><br/> --><div style="font-size:larger;">
        ...
        <div style="font-size:larger;">
            Select filter : &nbsp;&nbsp; <asp:DropDownList ID="DDL_for_state_filter" runat="server" AutoPostBack="true" OnSelectedIndexChanged="state_filter_DDL_change" DataTextField="StateName" DataValueField="SrNo" EnableIncrementalSearch="true" Width="300px" ></asp:DropDownList>  
