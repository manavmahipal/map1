<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="state_MO_new.aspx.cs" Inherits="merit.state_MO_new" %>
...
<body>
    ...
    <!-- <div style="width:100%;height: 50px; background-color: deepskyblue; background-image: radial-gradient( #c6e9f7,#05adf0 );font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size:30px;text-align:center;vertical-align:middle;"><b>Merit Order Dashboard</b></div>
       <br/><br/> --><div style="font-size:larger;">
            ...
            Select Month : &nbsp;&nbsp;  <asp:DropDownList ID="DDL_for_month" runat="server" AutoPostBack="true" OnSelectedIndexChanged="month_DDL_change" DataTextField="month1" DataValueField="month2" ></asp:DropDownList>  
        </div><br/><div style="font-size:larger;">
         </div><div style="font-size:larger;">
            Select filter: &nbsp;&nbsp;  <asp:DropDownList ID="DDL_for_month_filter" runat="server" AutoPostBack="true" OnSelectedIndexChanged="month_filter_DDL_change" DataTextField="date_from1" DataValueField="date_to" ></asp:DropDownList>  
        </div><br/><br/><div style="font-size:larger;">
         </div><br/>
         ...
         <asp:GridView ID="testgrid" runat="server" CssClass="hover" OnRowDataBound="grd_RowDataBound" AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical"> 
               ...
               <Columns>
							<asp:TemplateField HeaderText="SrNo1" HeaderStyle-HorizontalAlign="Center">  
           <ItemTemplate>  
               <%#Eval("SrNo1")%>  
           </ItemTemplate>  
                                <HeaderStyle HorizontalAlign="Center" />
       </asp:TemplateField>  
                   <asp:TemplateField HeaderText="StationName" HeaderStyle-HorizontalAlign="Center">  
           <ItemTemplate>  
               <%#Eval("StationName")%>  
           </ItemTemplate>  
                                <HeaderStyle HorizontalAlign="Center" />
       </asp:TemplateField> 
                   <asp:TemplateField HeaderText="Prev VC" HeaderStyle-HorizontalAlign="Center">  
           <ItemTemplate>  
               <%#Eval("VC1")%>  
           </ItemTemplate>  
                                <HeaderStyle HorizontalAlign="Center" />
       </asp:TemplateField> 
                   <asp:TemplateField HeaderText="Curr VC" HeaderStyle-HorizontalAlign="Center">  
           <ItemTemplate>  
               <%#Eval("VC2")%>  
           </ItemTemplate>  
                                <HeaderStyle HorizontalAlign="Center" />
       </asp:TemplateField> 
                   <asp:TemplateField HeaderText="change in VC" HeaderStyle-HorizontalAlign="Center">  
           <ItemTemplate>  
               <%#Eval("diff_VC")%>  
           </ItemTemplate>  
                                <HeaderStyle HorizontalAlign="Center" />
       </asp:TemplateField> 
                   <asp:TemplateField HeaderText="Change in position" HeaderStyle-HorizontalAlign="Center">  
           <ItemTemplate>  
                <img src="<%#get_imglink(Eval("Diff_SrNo").ToString()) %>" width="30px"/> <span style="color:<%#get_colorlink(Eval("Diff_SrNo").ToString()) %>;"><%#Eval("Diff_SrNo")%></span>  
           </ItemTemplate>  
                                <HeaderStyle HorizontalAlign="Center" />
       </asp:TemplateField> 
						</Columns>
